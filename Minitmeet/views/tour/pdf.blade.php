...
<div class="tourspacer container_24">
    <div class="grid_7 bggreen tournav steinem">
        <ul class="tournavul">
            ...
            <li class="active">{{ HTML::linkAction('TourController@pdf','PDF REPORT') }}</li> 
...
<div class="tourspacer container_24">
    <div class="heading_mob"><h2>PDF REPORT</h2></div>
   <?php $first_path = $first->path;
           $a= explode('/',$first_path);  
     ?>
   ...
   <!-- .tourtext -->
        ...
        <ul class="tournavul_mob">
            ...
            <li class="active">{{ HTML::linkAction('TourController@pdf','3') }} |</li> 
