...
<div class="tourspacer container_24">
    <div class="grid_7 bggreen tournav steinem">
        <ul class="tournavul">
            ...
            <li>{{ HTML::linkAction('TourController@create','CREATE MINUTES') }}</li> 
            <li>{{ HTML::linkAction('TourController@pdf','PDF REPORT') }}</li> 
            <li class="active">{{ HTML::linkAction('TourController@contacts','CONTACT LIST') }}</li>
        </ul>
     ...
     ?>
      ...
      <img class="slide1" alt="Overview" src="{{URL::to('/uploads')}}/{{$first_path}}" >
         <?php  $i=2;  foreach($image as $value ){
						 ...
						 $exp =explode('/',$path);
						?>  
      <img class="slide{{$i++}}" alt="Overview" src="{{URL::to('/uploads')}}/{{$path}}">
      <?php }
      ?>        
...
<div class="tourspacer container_24">
    <div class="heading_mob"><h2>CONTACT LIST</h2></div>
    <?php $first_path = $first->path;
           $a= explode('/',$first_path);  
     ?>
   ...
   <!-- .tourtext -->
        ...
        <ul class="tournavul_mob">
            ...
            <li>{{ HTML::linkAction('TourController@create','2') }} |</li> 
            <li>{{ HTML::linkAction('TourController@pdf','3') }} |</li> 
            <li class="active">{{ HTML::linkAction('TourController@contacts','4') }}</li>
            <li> > </li>
        </ul>
    </div><!-- .tournav -->
</div><!--.tourspacer-->
