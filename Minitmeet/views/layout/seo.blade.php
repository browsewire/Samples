...
<div id="header-wrapper" class="container">
		<div id="user-account" class="row" >
			...
			<div class="ninecol last">{{ HTML::link('logout', 'Logout',array('class'=>'bluebutton')) }} <span></span> <span>Welcome, <strong>{{strtoupper(Auth::User()->username)}}</strong></span> </div>
		</div>
		...
		<div class="row">
			...
			<div id="sidebar" class="threecol">
				<ul id="navigation">
					...
					<li><a href="{{URL::to('/admin/orders')}}">Payment <span class="icon-forms"></span></a></li>					
