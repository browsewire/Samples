...
<html lang="en-US">
	...
	<body>		
		<div>
{{$minute->first_name.' '. $minute->last_name}} whose email address is {{$minute->email}} has asked us to send this email to you. This is a reminder that the following task needs to be completed soon:
