...
{{$minute->first_name.' '. $minute->last_name}} whose email address is {{$minute->email}} has asked us to send this email to you. Please find your meeting {{$type}} attached to this email.
