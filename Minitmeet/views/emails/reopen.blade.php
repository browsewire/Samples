...
{{$minute->first_name." ". $minute->last_name}} whose email address is {{$minute->email}} has asked us to send this email to you. This task has been updated to: REOPENED status
