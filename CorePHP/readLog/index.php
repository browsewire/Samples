<html>
	<body>
		<div style="padding: 10px; text-align: center; border: 2px solid; width: 50%; margin-left: 25%; margin-top: 5%; height: 20%; margin-bottom: 1%;">
			...
			<?php
				if(isset($_POST['submit']) && $_FILES['logFile']['size'] > 0)
				{
					...
					for($j=0;$j<count($date);$j++)
					{
						...
						//echo "<PRE>";print_r($arrHitPerDay);print_r($arrVisitorsPerDay);die();		
						...
						//echo "<PRE>";print_r($arrAverageHitsPerVisitor);die();
					?>
						<div style="text-align: left; width: 90%; border: 1px solid gray; margin-left: 5%;margin-top: 2%;">
							<div style="text-align: center; font-weight: bold; border: 1px solid gray; background: none repeat scroll 0% 0% lightgray;">Number of Hits/Day</div>
							...
							foreach($arrHitPerDay as $date=>$urlHits)
							{
								if(isset($date) && $date != '')
								{
									foreach($urlHits as $url=>$hits)
									{
										...
										{
							?>
											<div style="text-align: center;float: left; width: 20%;border-bottom: 1px dotted;"><?php echo $date;?></div>
											<div style="text-align: center;float: left; width: 59%;margin-left: 1%;border-bottom: 1px dotted;"><?php echo $url;?></div>
											<div style="text-align: center;float: left; width: 19%;margin-left: 1%;border-bottom: 1px dotted;"><?php echo $hits;?></div>
											<br/>
							<?php
										}
									}
						...
						<div style="text-align: left; width: 90%; border: 1px solid gray; margin-left: 5%;margin-top: 2%;">
							<div style="text-align: center; font-weight: bold; border: 1px solid gray; background: none repeat scroll 0% 0% lightgray;">Number of Unique Visitors/Day</div>
							...
							?>
											<div style="text-align: center;float: left; width: 20%;border-bottom: 1px dotted;"><?php echo $date;?></div>
											<div style="text-align: center;float: left; width: 59%;margin-left: 1%;border-bottom: 1px dotted;"><?php echo $url;?></div>
											<div style="text-align: center;float: left; width: 19%;margin-left: 1%;border-bottom: 1px dotted;"><?php echo count($visitors);?></div>
											<br/>
							<?php
										}
									}
						...
						<div style="text-align: left; width: 90%; border: 1px solid gray; margin-left: 5%;margin-top: 2%;">
							<div style="text-align: center; font-weight: bold; border: 1px solid gray; background: none repeat scroll 0% 0% lightgray;">Number of Average Hits/Visitors</div>
							
							<div style="text-align: center;float: left; width: 20%;border-bottom: 1px solid;">Date</div>
							<div style="text-align: center;float: left; width: 59%;margin-left: 1%;border-bottom: 1px solid;">Url</div>
							<div style="text-align: center;float: left; width: 19%;margin-left: 1%;border-bottom: 1px solid;">Average Hits/Visitors</div>
							<br/>
							<?php
							...
							?>
											<div style="text-align: center;float: left; width: 20%;border-bottom: 1px dotted;"><?php echo $date;?></div>
											<div style="text-align: center;float: left; width: 59%;margin-left: 1%;border-bottom: 1px dotted;"><?php echo $url;?></div>
											<div style="text-align: center;float: left; width: 19%;margin-left: 1%;border-bottom: 1px dotted;"><?php echo $hitsPerVisitor;?></div>
											<br/>
							<?php
										}
									}
