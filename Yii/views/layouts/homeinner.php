...
<script>
	...
	if (navigator.userAgent.search("MSIE") >= 0 && ver <= 8)
	{
		//alert("IE");
	}
	else 
	{
		document.write('<scr'+'ipt type="text/javascript" src="http://d3lp1msu2r81bx.cloudfront.net/kjs/js/lib/kinetic-v4.4.1.min.js" ></scr'+'ipt>'); 
		//alert("mozilla");
	}
